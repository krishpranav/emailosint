...
class Banner:
	def banner(self):
		...
		print("-==[ Krishpranav ")
		print("-==[ %shttps://github.com/krishpranav%s "%(Y%0,E))
		print("_"*40 + "\n")

	def usage(self,_exit_=False):
		self.banner()
		print("Usage: emailosint.py [OPTIONS]\n")
		...
		print("Example:")
		print("\temailosint.py --domain site.gov -v 3")
		print("\temailosint.py --info admin@site.gov -v 3")
		print("\temailosint.py --domain site.gov --source pgp --breach -v 1")
		print("\temailosint.py --domain site.gov --source google --breach --report site_gov.txt -v 3\n")
		if _exit_: exit(0)